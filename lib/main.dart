...
import 'page/wiredash/CustomWiredashTranslationsDelegate.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Wiredash(
        projectId: 'nbread-xj2kd1h',
        secret: '7GR1rUiRr7YFvxyC0uTBHQS7n5BqDT4J',
            ...
            outlinedButtonTheme: OutlinedButtonThemeData(
                style: OutlinedButton.styleFrom(
                    ...
                    side: const BorderSide(
                        width: 1.0, color: ColorStyle.mainColor),
